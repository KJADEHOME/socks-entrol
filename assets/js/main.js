...
const i18n = {
    en: {
        ...
        productsPage: {
            ...
            cat5: 'Indoor Shoes',
            cat6: 'Foot Covers',
            cat7: 'Shea Butter Feather Yarn Socks',
            ...
            s7f1: 'Signature Specialty: Feather yarn construction with shea butter treatment options',
        ...
        aboutPage: {
            ...
            capImg1: 'Sock Knitting Workshop',
            capImg2: 'Factory Campus',
            capImg3: 'Sock Knitting Workshop',
            cap1Title: 'Knitting Workshop',
            cap1Desc: 'A production-floor view of sock knitting machines operating inside the Zhuji Rongxing factory.',
            cap2Title: 'Factory Campus',
            cap2Desc: 'An exterior view of the Zhuji Rongxing factory buildings in Datang Town, Zhuji, Zhejiang.',
            cap3Title: 'Knitting Workshop',
            cap3Desc: 'Another view of the sock knitting equipment and organized production floor inside the factory.',
    ...
    zh: {
        ...
        aboutPage: {
            ...
            capImg3: '织造车间',
            cap1Title: '织造车间',
            cap1Desc: '诸暨荣兴工厂内袜机织造生产现场实景。',
            cap2Title: '厂区实景',
            cap2Desc: '位于浙江省诸暨市大唐镇的诸暨荣兴厂房外景。',
            cap3Title: '织造车间',
            cap3Desc: '工厂内袜机设备及整齐有序的织造生产现场。',
            certTitle: '认证资质',
